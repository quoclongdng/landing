		...
		<nav class="navbar navbar-expand-lg">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto">
                    <li class="dropdown animation" data-animation="fadeInDown" data-animation-delay="1.1s"><a class="nav-link page-scroll nav_item" href="#home_section">Home</a></li>
...
<section id="home_section" class="section_banner bg_navy_blue banner_full_height" data-z-index="1" data-parallax="scroll" data-image-src="assets/images/banner_bg2.png">
                    ...
                    <div class="row align-items-center h-100">
                    	<div class="col-lg-7">
                            <div class="tk_counter_inner text-center">
                                <div class="tk_countdown_time p-0 transparent_bg box_shadow_none animation" data-animation="fadeInUp" data-animation-delay="0.2s" data-time="2022/01/01 00:00:00"></div>
                                <div class="progress animation" data-animation="fadeInUp" data-animation-delay="0.3s">
                                <div class="progress-bar progress-bar-striped gradient" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width:10%"> 10% </div>
...
<section id="roadmap" class="bg_navy_blue" data-image-src="assets/images/roadmap_bg3.png" data-parallax="scroll" data-z-index="1">
    <div class="container">
    	...
    	<div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 order-lg-first">
                <div class="res_md_mt_50 res_sm_mt_20 text-center animation" data-animation="fadeInLeft" data-animation-delay="0.2s">
                    <img class="bounceimg" src="assets/images/mobile_app6.png" alt="mobile_app6">
                </div>
            </div>
...
<section id="team" class="bg_navy_blue team_box_s2">
    <div class="container">
        ...
        <div class="row small_space">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 res_md_mb_30 res_sm_mb_20">
                <div class="bg_navy_blue_dark radius_box team_box_s3 animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                    <div class="text-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 res_md_mb_30 res_sm_mb_20">
                <div class="bg_navy_blue_dark radius_box team_box_s3 animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                    <div class="text-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="bg_navy_blue_dark  radius_box team_box_s3 animation" data-animation="fadeInUp" data-animation-delay="1s">
                    <div class="text-center">
                    ...
                    <ul class="list_none contact_info mt-margin">
                        ...
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                            ...
                            <div class="contact_detail"> <span>Email-id</span>
                            	<p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1f46706a6d727e76735f78727e7673317c7072">[email&#160;protected]</a></p>
                            </div>
                        </li>
                  </ul>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 offset-lg-3">
            	<div class="title_default_light title_border text-center">
                    <h4 class="footer_title animation" data-animation-delay="0.2s" data-animation="fadeInUp">Don't Miss ICO News And Updates!</h4>
                    <p class="text-white m-0 animation" data-animation-delay="0.4s" data-animation="fadeInUp">By subscribing to our mailing list you will always be<br class="d-none d-md-block"> update with the latest news from us.</p>
                </div>
                <div class="newsletter_form newslattter_small my-2 my-md-5">
                <form class="subscribe_form animation" data-animation="fadeInUp" data-animation-delay="0.5s">
                ...
                <div class="social_chat text_md_center">
                	<span class="chat_title animation" data-animation="fadeInUp" data-animation-delay="0.6s">Join our chat:</span>
                    <a href="#" class="btn btn-default btn-radius mx-3 my-2  animation" data-animation="fadeInUp" data-animation-delay="0.7s"><i class="fa fa-send"></i>Telegram</a>
                    <ul class="list_none social_icon">
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.8s"><a href="#"><i class=" fa fa-facebook"></i></a></li>
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.9s"><a href="#"><i class=" fa fa-twitter"></i></a></li>
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="1s"><a href="#"><i class=" fa fa-google-plus"></i></a></li>
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="1.1s"><a href="#"><i class=" fa fa-pinterest"></i></a></li>
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="1.2s"><a href="#"><i class=" fa fa-linkedin"></i></a></li>
                     </ul>
                </div>
            </div>
        </div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 text-center">
                    ...
                    <ul class="footer_link_s2">
                        ...
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.6s"><a href="#">Whitepaper</a></li>
